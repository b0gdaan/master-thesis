...
\begin{figure}[H]
    ...
    \caption{Rolling dependency between Bitcoin and each of the five conventional assets plus Ethereum (six pairs in all) across all four window lengths (14, 30, 60, 90 days). The Fisher-transformed series illustrates the strong time-variation and persistence that motivate the forecasting framework.}
