\section{Supplementary Forecasting Results}
...
\begin{figure}[H]
    ...
    \caption{RMSE by model and window for the representative Bitcoin--S\&P~500 pair.}
...
\begin{figure}[H]
    ...
    \caption{Regularisation path for the Ridge-based forecasting specification.}
...
\begin{figure}[H]
    ...
    \caption{Random Forest feature importances for the Bitcoin--S\&P~500 pair at the 30-day window.}
...
Taken together, these figures support the main text. Forecast quality depends strongly on the choice of rolling window, while the target remains largely driven by persistence. The differences between model families are also clearer in a comparative plot than in any single ranking number.
