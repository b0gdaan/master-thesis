...
Figure~\ref{fig:eda_prices_appendix} presents normalized price paths for the asset universe. The normalisation puts all series on a common starting point, which makes visible how different the underlying market trajectories are.
